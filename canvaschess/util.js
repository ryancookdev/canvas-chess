...
CHESS.util.setPosition = function (pos, fen) {
    var fen_arr,
        position,
        castling,
        row_array = [],
...
CHESS.util.getFEN = function (pos) {
    var fen_arr = [],
        position,
        castling = '',
        en_passant = '',
...
CHESS.util.isLegal = function (pos, sq1, sq2) {
    var i,
        xy1,
        xy2,
        x1,
...
CHESS.util.clonePositionArray = function (old_array) {
    ...
    if (pos.white_to_move) {
        ...
        if (piece.substr(0, 2) === 'wp' && w_y2 === 0) {
            if (promotion === 'r') {
                ...
                pos.position_array[w_y2][w_x2] = 'wb';
            } else if (promotion === 'n') {
                pos.position_array[w_y2][w_x2] = 'wn';
            } else {
                pos.position_array[w_y2][w_x2] = 'wq';
            }
        }
