var CHESS=CHESS||{};CHESS.config={library_path:"canvaschess"};CHESS.nag_code={"0":"","1":"!","2":"?","3":"!!","4":"??","5":"!?","6":"?!","10":"="};CHESS.hexToRgba=function(c){var b=/^#?([a-f\d])([a-f\d])([a-f\d])$/i;c=c.replace(b,function(e,h,f,d){return h+h+f+f+d+d});var a=/^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(c);return(a?{r:parseInt(a[1],16),g:parseInt(a[2],16),b:parseInt(a[3],16),a:1}:null)};
