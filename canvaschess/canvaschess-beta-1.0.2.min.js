var CHESS=CHESS||{};CHESS.nag_code={"0":"","1":"!","2":"?","3":"!!","4":"??","5":"!?","6":"?!","10":"=","14":"+/=","15":"=/+","16":"+/-","17":"-/+","18":"+-","19":"-+"};CHESS.hexToRgba=function(c){var b=/^#?([a-f\d])([a-f\d])([a-f\d])$/i;c=c.replace(b,function(e,h,f,d){return h+h+f+f+d+d});var a=/^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(c);return(a?{r:parseInt(a[1],16),g:parseInt(a[2],16),b:parseInt(a[3],16),a:1}:null)};
...
CHESS.Board=function(d){var e,b={subscribers:{any:[]}},c=CHESS.engine.createPosition(),a={container:null,canvas:null,ctx:null,snapshot:null,snapshot_ctx:null,snapshot_img:new Image(),square_size:0,square_color_light:"#ececd7",square_color_dark:"#7389b6",square_hover_light:"#b4d990",square_hover_dark:"#85c249",square_light:new Image(),square_dark:new Image(),dpi_ratio:1,dragok:false,drag_piece:"",drag_clear_i:0,drag_clear_j:0,image_path:"canvaschess/img/",left:0,top:0,last_draw_left:0,last_draw_top:0,piece_not_lifted:true,white_down:true,gc_opacity:"0.8",highlight_move:false,highlight_move_color:"#FF0000",highlight_move_opacity:"0.5",highlight_hover:false,piece_set:"canvaschess/img/pieces/merida/",show_row_col_labels:true,arrow_list:[],square_list:[],wp:new Image(),wr:new Image(),wn:new Image(),wb:new Image(),wq:new Image(),wk:new Image(),bp:new Image(),br:new Image(),bn:new Image(),bb:new Image(),bq:new Image(),bk:new Image()};b.myCancel=function(f){f.preventDefault();a.dragok=false;a.drag_piece="";a.left=0;a.top=0;a.takeSnapshot()};b.myDown=function(m){var g,f,h,l,k=a.canvas.getBoundingClientRect();if(c.active){if(m.hasOwnProperty("clientX")){a.left=m.clientX-k.left;a.top=m.clientY-k.top;a.canvas.style.cursor="move"}else{if(m.hasOwnProperty("changedTouches")){a.left=m.changedTouches[0].pageX-k.left;a.top=m.changedTouches[0].pageY-k.top}else{return}}a.top=a.top*a.dpi_ratio;a.left=a.left*a.dpi_ratio;g=parseInt(a.top/a.square_size,10);f=parseInt(a.left/a.square_size,10);if(!a.white_down){g=7-g;f=7-f}if(g<8){h=c.position_array[g][f]}else{if(c.mode==="setup"){h=c.piecebox_array[g-8][f]}}l=h.substr(0,1);if(c.mode!=="setup"&&((c.white_to_move&&l==="b")||(!c.white_to_move&&l==="w"))){a.canvas.style.cursor="default";return}if(h!==""){a.drag_clear_i=g;a.drag_clear_j=f;a.drag_piece=h;a.dragok=true;a.takeSnapshot(false)}else{a.canvas.style.cursor="default"}}};b.myMove=function(p){p.preventDefault();var q=a,k,h,v,n,w,o,m,l,g,u,t,r,s=q.canvas.getBoundingClientRect(),f=q.square_size*8;if(q.dragok){k=parseInt(q.top/q.square_size,10);h=parseInt(q.left/q.square_size,10);o=(h-1)*q.square_size;m=(k-1)*q.square_size;l=q.square_size*3;g=q.square_size*3;if(!(k<0||k>7||h<0||h>7)){if(o<0){o=0}if(m<0){m=0}if(o+l>f){l=f-o}if(m+g>f){g=f-m}q.ctx.drawImage(q.snapshot,o,m,l,g,o,m,l,g)}if(p.hasOwnProperty("clientX")){q.left=p.clientX-s.left;q.top=p.clientY-s.top}else{if(p.hasOwnProperty("changedTouches")){q.left=p.changedTouches[0].pageX-s.left;q.top=p.changedTouches[0].pageY-s.top}else{return}}q.top=q.top*q.dpi_ratio;q.left=q.left*q.dpi_ratio;k=parseInt(q.top/q.square_size,10);h=parseInt(q.left/q.square_size,10);if(k<0||k>7||h<0||h>7){return}if(q.highlight_hover){q.drawSquare("hover",k*q.square_size,h*q.square_size)}v=k;n=h;if(!q.white_down){v=7-k;n=7-h}w=c.position_array[v][n].substr(0,2);if(w!==""&&!(v===q.drag_clear_i&&n===q.drag_clear_j)){u=parseInt((h*q.square_size),10);t=parseInt((k*q.square_size),10);q.ctx.drawImage(q[w],u,t,q.square_size,q.square_size)}w=q.drag_piece.substr(0,2);u=parseInt(((q.left-(q.square_size/2))),10);t=parseInt(((q.top-(q.square_size/2))),10);r=q.square_size;if(c.mode==="setup"&&q.top>q.square_size*7.5){r=r-((q.top-q.square_size*7.5))}q.ctx.drawImage(q[w],u,t,q.square_size,q.square_size)}};b.myUp=function(n){var m,k,h=["a","b","c","d","e","f","g","h"],o,l,g,f,s,r,p=a.canvas.getBoundingClientRect(),q;if(c.active&&a.dragok){if(n.hasOwnProperty("clientX")){o=(n.clientX-p.left)*a.dpi_ratio;l=(n.clientY-p.top)*a.dpi_ratio;g=parseInt(l/a.square_size,10);f=parseInt(o/a.square_size,10);a.canvas.style.cursor="default"}else{if(n.hasOwnProperty("changedTouches")){o=(n.changedTouches[0].pageX-p.left)*a.dpi_ratio;l=(n.changedTouches[0].pageY-p.top)*a.dpi_ratio;g=parseInt(l/a.square_size,10);f=parseInt(o/a.square_size,10)}else{return}}if(!a.white_down){g=7-g;f=7-f}q=a.drag_piece;a.dragok=false;a.drag_piece="";a.left=0;a.top=0;a.piece_not_lifted=true;if(a.drag_clear_i>=8){m="piecebox"}else{m=h[a.drag_clear_j]+(8-a.drag_clear_i)}if(g>=8){k="piecebox"}else{k=h[f]+(8-g)}s=CHESS.engine.getArrayPosition(m);r=CHESS.engine.getArrayPosition(k);if(c.mode==="setup"){if(m!==k&&m!=="piecebox"&&k!=="piecebox"){c.position_array[r.substr(1,1)][r.substr(0,1)]=q;c.position_array[s.substr(1,1)][s.substr(0,1)]=""}else{if(m==="piecebox"&&k==="piecebox"){}else{if(m==="piecebox"){c.position_array[r.substr(1,1)][r.substr(0,1)]=q}else{if(k==="piecebox"){c.position_array[s.substr(1,1)][s.substr(0,1)]=""}}}}}else{c.move(m,k)}a.takeSnapshot()}};b.publish=function(f,g){this.visitSubscribers("publish",f,g)};b.visitSubscribers=function(l,g,k){var h=k||"any",m=this.subscribers[h],j,f=0;if(m!==undefined){f=m.length}for(j=0;j<f;j+=1){if(l==="publish"){m[j](g)}else{if(m[j]===g){m.splice(j,1)}}}};b.resize=function(h,j){var g,i,m=0,l=8,f=window.devicePixelRatio||1,k=a.ctx.webkitBackingStorePixelRatio||a.ctx.mozBackingStorePixelRatio||a.ctx.msBackingStorePixelRatio||a.ctx.oBackingStorePixelRatio||a.ctx.BackingStorePixelRatio||1;h=h||0;j=j||0;h=parseInt(h,10);j=parseInt(j,10);if(h===0||j===0){h=parseInt(window.getComputedStyle(a.canvas.parentNode,null).getPropertyValue("height"),10);j=parseInt(window.getComputedStyle(a.canvas.parentNode,null).getPropertyValue("width"),10)}m=(h<j?h:j);if(c.mode==="setup"){l=10}a.square_size=(h<j?parseInt(m/l,10):parseInt(m/8,10));a.canvas.height=a.square_size*l;a.canvas.width=a.square_size*8;a.dpi_ratio=f/k;if(f!==k){g=a.canvas.width,i=a.canvas.height;a.canvas.width=g*a.dpi_ratio;a.canvas.height=i*a.dpi_ratio;a.canvas.style.width=g+"px";a.canvas.style.height=i+"px";a.square_size=a.canvas.width/8}};c.move=function(g,f){var l={position_array:CHESS.engine.clonePositionArray(this.position_array),white_to_move:this.white_to_move,en_passant:this.en_passant,active:this.active,gs_castle_kside_w:this.gs_castle_kside_w,gs_castle_qside_w:this.gs_castle_qside_w,gs_castle_kside_b:this.gs_castle_kside_b,gs_castle_qside_b:this.gs_castle_qside_b},i={fen:CHESS.engine.getFEN(this),player_to_move:(this.white_to_move?"w":"b"),sq1:g,sq2:f,promote:false,mate:false,stalemate:false},k,j,h;if(this.last_move){l.last_move={sq1:this.last_move.sq1,sq2:this.last_move.sq2}}k=CHESS.engine.getArrayPosition(g);j=CHESS.engine.getArrayPosition(f);h=c.position_array[k.substr(1,1)][k.substr(0,1)].substr(1,1);if(h==="p"&&((c.white_to_move&&f.substr(1,1)==="8")||(!c.white_to_move&&f.substr(1,1)==="1"))){i.promote=true}if(!CHESS.engine.moveTemp(l,g,f)){a.takeSnapshot();return}a.arrow_list=[];if(CHESS.engine.isMate(l)){i.mate=true}else{if(CHESS.engine.isStalemate(l)){i.stalemate=true}}b.publish(i,"move_before");this.position_array=CHESS.engine.clonePositionArray(l.position_array);this.white_to_move=l.white_to_move;this.en_passant=l.en_passant;this.active=l.active;this.gs_castle_kside_w=l.gs_castle_kside_w;this.gs_castle_qside_w=l.gs_castle_qside_w;this.gs_castle_kside_b=l.gs_castle_kside_b;this.gs_castle_qside_b=l.gs_castle_qside_b;this.moves+=1;if(l.last_move){this.last_move={sq1:l.last_move.sq1,sq2:l.last_move.sq2}}a.takeSnapshot();if(!this.active){return}};c.setPosition=function(f){CHESS.engine.setPosition(this,f)};a.buildHtml=function(f){this.canvas=document.createElement("canvas");this.canvas.className="chessboard";this.canvas.setAttribute("tabindex",0);this.ctx=this.canvas.getContext("2d");this.snapshot=document.createElement("canvas");this.snapshot_ctx=this.snapshot.getContext("2d");if(f!==undefined){document.getElementById(f).appendChild(this.canvas)}};a.arrowAdd=function(h,f,g,i){var j=CHESS.hexToRgba(g);j.a=i;this.arrow_list.push({sq1:h,sq2:f,rgba:j})};a.arrowDraw=function(h,f,o){var u,t,w,l,v,k,r,C,q,z,p=10,s=(this.square_size/2)-5,x=Math.PI/6,B,g,j,n,m,i,A,y;u=CHESS.engine.getArrayPosition(h);t=CHESS.engine.getArrayPosition(f);w=u.substr(0,1);l=u.substr(1,1);v=t.substr(0,1);k=t.substr(1,1);if(!a.white_down){w=7-w;l=7-l;v=7-v;k=7-k}w=w*this.square_size+(this.square_size/2);l=l*this.square_size+(this.square_size/2);v=v*this.square_size+(this.square_size/2);k=k*this.square_size+(this.square_size/2);if(w===v){r=v;C=(k>l?k-s:k+s)}else{q=(k-l)/(v-w);z=Math.sqrt(((s*s)/(1+q*q)));r=(v>w?v-z:v+z);C=q*(r-v)+k}this.snapshot_ctx.beginPath();this.snapshot_ctx.strokeStyle="rgba("+o.r+","+o.g+","+o.b+", "+o.a+")";this.snapshot_ctx.fillStyle="rgba("+o.r+","+o.g+","+o.b+", "+o.a+")";this.snapshot_ctx.lineWidth=p;this.snapshot_ctx.moveTo(w,l);this.snapshot_ctx.lineTo(r,C);this.snapshot_ctx.stroke();B=Math.atan2(k-l,v-w);g=Math.abs(s/Math.cos(x));j=B+Math.PI+x;n=v+Math.cos(j)*g;m=k+Math.sin(j)*g;i=B+Math.PI-x;A=v+Math.cos(i)*g;y=k+Math.sin(i)*g;this.snapshot_ctx.beginPath();this.snapshot_ctx.lineWidth=2;this.snapshot_ctx.moveTo(A,y);this.snapshot_ctx.lineTo(n,m);this.snapshot_ctx.lineTo(v,k);this.snapshot_ctx.lineTo(A,y);this.snapshot_ctx.fill()};a.arrowDrawAll=function(){var j,g,f,h;for(j=0;j<this.arrow_list.length;j+=1){g=this.arrow_list[j].sq1;f=this.arrow_list[j].sq2;h=this.arrow_list[j].rgba;a.arrowDraw(g,f,h)}};a.squareAdd=function(i,f,g){var h=CHESS.hexToRgba(f);h.a=g;this.square_list.push({sq:i,rgba:h})};a.squareDraw=function(h,g){var i,f,j;i=CHESS.engine.getArrayPosition(h);f=i.substr(0,1);j=i.substr(1,1);if(!a.white_down){f=7-f;j=7-j}this.snapshot_ctx.beginPath();this.snapshot_ctx.fillStyle="rgba("+g.r+","+g.g+","+g.b+", "+g.a+")";this.snapshot_ctx.rect(f*this.square_size,j*this.square_size,this.square_size,this.square_size);this.snapshot_ctx.fill()};a.squareDrawAll=function(){var g,h,f;for(g=0;g<this.square_list.length;g+=1){h=this.square_list[g].sq;f=this.square_list[g].rgba;a.squareDraw(h,f)}};a.drawPiece=function(g,f,h){this.snapshot_ctx.drawImage(this[g],f,h,this.square_size,this.square_size)};a.drawSquare=function(k,o,n,f){var p=f||this.snapshot_ctx,i,g=parseInt(o/this.square_size,10),q=parseInt(n/this.square_size,10),l,h,m=parseInt(this.square_size/55*13,10),j=parseInt(this.square_size/55*9,10);if(k==="hover"){this.ctx.beginPath();if((g+q)%2===0){this.ctx.fillStyle=this.square_hover_light}else{this.ctx.fillStyle=this.square_hover_dark}this.ctx.rect(q*this.square_size,g*this.square_size,this.square_size,this.square_size);this.ctx.fill()}else{i=(k==="light"?this.square_light:this.square_dark);if(i.src!==""){this.snapshot_ctx.drawImage(i,0,0,this.square_size,this.square_size,o,n,this.square_size,this.square_size)}else{this.snapshot_ctx.beginPath();this.snapshot_ctx.fillStyle=(k==="light"?this.square_color_light:this.square_color_dark);this.snapshot_ctx.rect(o,n,this.square_size,this.square_size);this.snapshot_ctx.fill()}}if(this.show_row_col_labels&&(q===7||g===0)){h=parseInt(this.square_size/55*12,10),this.snapshot_ctx.font=h+"px arial";this.snapshot_ctx.fillStyle=(((7-q)+g)%2===0?this.square_color_light:this.square_color_dark);if(g===0){if(this.white_down){l=8-q}else{l=q+1}this.snapshot_ctx.fillText(l,2,(q*this.square_size)+m)}if(q===7){if(this.white_down){l=String.fromCharCode(g+97)}else{l=String.fromCharCode((7-g)+97)}this.snapshot_ctx.fillText(l,((this.square_size*g)+this.square_size)-j,(this.square_size*8)-2)}}};a.takeSnapshot=function(o){var k,g,r,l,q,p,m,h,t,s=8,n,f=CHESS.hexToRgba(this.highlight_move_color);if(c.mode==="setup"){s=10}this.snapshot.width=this.square_size*8;this.snapshot.height=this.square_size*s;for(p=0;p<8;p+=1){for(q=0;q<8;q+=1){if((q+p)%2===0){m=q*this.square_size;h=p*this.square_size;this.drawSquare("light",m,h)}}}for(p=0;p<8;p+=1){for(q=0;q<8;q+=1){if((q+p)%2!==0){m=q*this.square_size;h=p*this.square_size;this.drawSquare("dark",m,h)}}}if(this.highlight_move){if(typeof c.last_move==="object"&&c.last_move.sq1!==undefined){this.snapshot_ctx.beginPath();this.snapshot_ctx.fillStyle="rgba("+f.r+","+f.g+","+f.b+", "+this.highlight_move_opacity+")";q=c.last_move.sq1.substr(0,1);p=c.last_move.sq1.substr(1,1);if(!this.white_down){q=7-q;p=7-p}this.snapshot_ctx.rect(q*this.square_size,p*this.square_size,this.square_size,this.square_size);q=c.last_move.sq2.substr(0,1);p=c.last_move.sq2.substr(1,1);if(!this.white_down){q=7-q;p=7-p}this.snapshot_ctx.rect(q*this.square_size,p*this.square_size,this.square_size,this.square_size);this.snapshot_ctx.fill()}}this.squareDrawAll();for(k=0;k<8;k+=1){for(g=0;g<8;g+=1){if(!this.dragok||!(k===this.drag_clear_i&&g===this.drag_clear_j)){t=c.position_array[k][g].substr(0,2);r=k;l=g;if(!this.white_down){r=7-k;l=7-g}q=l*this.square_size;p=r*this.square_size;if(t!==""){this.drawPiece(t,q,p)}}}}if(c.mode==="setup"){for(k=0;k<2;k+=1){for(g=0;g<8;g+=1){t=c.piecebox_array[k][g].substr(0,2);q=g*this.square_size;p=(k+8)*this.square_size;if(t!==""){this.drawPiece(t,q,p)}}}}if(this.dragok){k=this.drag_clear_i;g=this.drag_clear_j;if(!this.white_down){k=7-this.drag_clear_i;g=7-this.drag_clear_j}n=(k+g)%2===0;if(n){if(this.square_light.src!==""){this.drawSquare("light",g*this.square_size,k*this.square_size,this.ctx)}else{this.snapshot_ctx.beginPath();this.snapshot_ctx.fillStyle=this.square_color_light;this.snapshot_ctx.rect(g*this.square_size,k*this.square_size,this.square_size,this.square_size);this.snapshot_ctx.fill()}}else{if(this.square_dark.src!==""){this.drawSquare("dark",g*this.square_size,k*this.square_size,this.ctx)}else{this.snapshot_ctx.beginPath();this.snapshot_ctx.fillStyle=this.square_color_dark;this.snapshot_ctx.rect(g*this.square_size,k*this.square_size,this.square_size,this.square_size);this.snapshot_ctx.fill()}}}this.arrowDrawAll();if(o===undefined){o=true}if(o){this.ctx.clearRect(0,this.square_size*8,this.square_size*8,this.square_size*2);this.ctx.drawImage(this.snapshot,0,0)}};this.addArrow=function(h,f,g,i){i=parseFloat(i);i=(i>=0&&i<=1?i:a.gc_opacity);i=(i>=0&&i<=1?i:1);a.arrowAdd(h,f,g,i);a.takeSnapshot()};this.addSquare=function(h,f,g){g=parseFloat(g);g=(g>=0&&g<=1?g:a.gc_opacity);g=(g>=0&&g<=1?g:1);a.squareAdd(h,f,g);a.takeSnapshot()};this.display=function(){a.takeSnapshot()};this.flip=function(){a.white_down=!a.white_down;a.takeSnapshot()};this.getActiveColor=function(){return(c.white_to_move?"w":"b")};this.getFEN=function(){return CHESS.engine.getFEN(c)};this.getCanvas=function(){return a.canvas};this.isMate=function(){return CHESS.engine.isMate(c)};this.isStalemate=function(){return CHESS.engine.isStalemate(c)};this.move=function(i){var h,g,f;h=CHESS.engine.getLongNotation(c,i);h=h.split("-");g=h[0];f=h[1];c.move(g,f)};this.positionClear=function(){c.position_array=[["","","","","","","",""],["","","","","","","",""],["","","","","","","",""],["","","","","","","",""],["","","","","","","",""],["","","","","","","",""],["","","","","","","",""],["","","","","","","",""]];c.last_move={};c.en_passant="";c.white_to_move=true;c.gs_castle_kside_w=true;c.gs_castle_qside_w=true;c.gs_castle_kside_b=true;c.gs_castle_qside_b=true;c.moves=0;a.takeSnapshot()};this.positionStart=function(){c.position_array=[["br","bn","bb","bq","bk","bb","bn","br"],["bp","bp","bp","bp","bp","bp","bp","bp"],["","","","","","","",""],["","","","","","","",""],["","","","","","","",""],["","","","","","","",""],["wp","wp","wp","wp","wp","wp","wp","wp"],["wr","wn","wb","wq","wk","wb","wn","wr"]];c.last_move={};c.en_passant="";c.white_to_move=true;c.gs_castle_kside_w=true;c.gs_castle_qside_w=true;c.gs_castle_kside_b=true;c.gs_castle_qside_b=true;c.moves=0;c.active=true;a.takeSnapshot()};this.removeArrow=function(){a.arrow_list.pop();a.takeSnapshot()};this.removeAllArrows=function(){a.arrow_list=[];a.takeSnapshot()};this.removeSquare=function(){a.square_list.pop();a.takeSnapshot()};this.removeAllSquares=function(){a.square_list=[];a.takeSnapshot()};this.resize=function(f,g){b.resize(f,g);a.takeSnapshot()};this.setActive=function(f){c.active=(f===true)};this.setLastMove=function(g,f){g=CHESS.engine.getArrayPosition(g);f=CHESS.engine.getArrayPosition(f);c.last_move={sq1:g,sq2:f}};this.setMode=function(f){c.mode=f;if(f==="setup"){c.active=true}b.resize(a.canvas.height,a.canvas.width);a.takeSnapshot()};this.setPosition=function(f){c.setPosition(f);c.active=true;a.takeSnapshot()};this.subscribe=function(g,f){g=g||"any";if(b.subscribers[g]===undefined){b.subscribers[g]=[]}b.subscribers[g].push(f)};this.unsubscribe=function(g,f){b.visitSubscribers("unsubscribe",g,f)};e=function(){var f;a.buildHtml(d.container);a.canvas.onmousedown=b.myDown;a.canvas.onmouseup=b.myUp;a.canvas.onmousemove=b.myMove;a.canvas.addEventListener("touchstart",b.myDown,false);a.canvas.addEventListener("touchend",b.myUp,false);a.canvas.addEventListener("touchmove",b.myMove,false);a.canvas.addEventListener("touchleave",b.myCancel,false);a.canvas.addEventListener("touchcancel",b.myCancel,false);a.highlight_move=(d.highlight_move===true?true:false);a.highlight_hover=(d.highlight_hover===true?true:false);a.show_row_col_labels=(d.show_row_col_labels===false?false:true);a.square_color_light=(d.square_color_light?d.square_color_light:a.square_color_light);a.square_color_dark=(d.square_color_dark?d.square_color_dark:a.square_color_dark);a.gc_opacity=(d.gc_opacity?d.gc_opacity:a.gc_opacity);a.highlight_move_color=(d.highlight_move_color?d.highlight_move_color:a.highlight_move_color);a.highlight_move_opacity=(d.highlight_move_opacity?d.highlight_move_opacity:a.highlight_move_opacity);a.square_hover_light=(d.square_hover_light?d.square_hover_light:a.square_hover_light);a.square_hover_dark=(d.square_hover_dark?d.square_hover_dark:a.square_hover_dark);a.piece_set=(d.piece_set?d.piece_set:a.piece_set);c.mode=d.mode;c.active=true;if(d.fen){c.setPosition(d.fen)}else{c.setPosition("rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1")}b.resize(d.height,d.width);f=(d.piece_set||"pieces/merida");f=f.replace(/\/$/,"");a.wp.src=f+"/wp.svg";a.wp.onload=function(){a.takeSnapshot()};a.wr.src=f+"/wr.svg";a.wr.onload=function(){a.takeSnapshot()};a.wn.src=f+"/wn.svg";a.wn.onload=function(){a.takeSnapshot()};a.wb.src=f+"/wb.svg";a.wb.onload=function(){a.takeSnapshot()};a.wq.src=f+"/wq.svg";a.wq.onload=function(){a.takeSnapshot()};a.wk.src=f+"/wk.svg";a.wk.onload=function(){a.takeSnapshot()};a.bp.src=f+"/bp.svg";a.bp.onload=function(){a.takeSnapshot()};a.br.src=f+"/br.svg";a.br.onload=function(){a.takeSnapshot()};a.bn.src=f+"/bn.svg";a.bn.onload=function(){a.takeSnapshot()};a.bb.src=f+"/bb.svg";a.bb.onload=function(){a.takeSnapshot()};a.bq.src=f+"/bq.svg";a.bq.onload=function(){a.takeSnapshot()};a.bk.src=f+"/bk.svg";a.bk.onload=function(){a.takeSnapshot()};if(typeof d.square_dark==="string"){a.square_dark.src=d.square_dark;a.square_dark.onload=function(){a.takeSnapshot()}}if(typeof d.square_light==="string"){a.square_light.src=d.square_light;a.square_light.onload=function(){a.takeSnapshot()}}};e()};
CHESS.PgnViewer=function(d){var e,b={},c={black:"",date:"",event:"",result:"",round:"",site:"",white:"",fen:"rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1",game_list:[]},a={board:null,board_control_box:null,container:null,control_box:null,control_end_elem:null,control_next_elem:null,control_pause_elem:null,control_play_elem:null,control_prev_elem:null,control_start_elem:null,current_move:null,download_btn:null,flip_board_btn:null,game_list:null,header_box:null,header_date_elem:null,header_details_box:null,header_event_elem:null,header_players_elem:null,header_result_elem:null,header_site_elem:null,main_box:null,move_control_box:null,move_list:null,ply:0,start_end_variation:false};b.goEnd=function(){if(a.current_move!==null){a.changeMove(a.current_move.parentNode.lastChild)}};b.goNext=function(){var f;if(a.current_move!==null){f=a.getSiblingMove(a.current_move,1);a.changeMove(f)}};b.goPrev=function(){var f;if(a.current_move!==null){f=a.getSiblingMove(a.current_move,-1);a.changeMove(f)}};b.goStart=function(){if(a.current_move!==null){a.changeMove(a.current_move.parentNode.firstChild)}};b.updateBoard=function(j){var f,h,g;a.board.setPosition(j.currentTarget.fen);a.board.setLastMove(j.currentTarget.move.sq1,j.currentTarget.move.sq2);a.board.removeAllArrows();a.board.removeAllSquares();if(typeof(j.currentTarget.gc)==="object"){h=j.currentTarget.gc;if(h.arrows.length>=1){for(f=0;f<h.arrows.length;f+=1){if(h.arrows[f].color==="R"){g="#F00"}else{if(h.arrows[f].color==="Y"){g="#FF0"}else{g="#0F0"}}a.board.addArrow(h.arrows[f].sq1,h.arrows[f].sq2,g)}}if(h.squares.length>=1){for(f=0;f<h.squares.length;f+=1){if(h.squares[f].color==="R"){g="#F00"}else{if(h.squares[f].color==="Y"){g="#FF0"}else{g="#0F0"}}a.board.addSquare(h.squares[f].sq,g)}}}a.board.display();a.board.setActive(true);if(a.current_move!==null){a.current_move.removeAttribute("class")}j.currentTarget.className="current";a.current_move=j.currentTarget};a.buildHtml=function(h,g){var j,l=document,k,f;if(h.id!==undefined){this.container=document.getElementById(h.id)}if(this.container===undefined||this.container===null){document.write("<div id='canvaschess' class='canvaschesspgn'></div>");this.container=document.getElementById("canvaschess");this.container.removeAttribute("id")}this.container.setAttribute("tabindex",0);this.main_box=l.createElement("div");this.main_box.className="pgn_main_box";this.container.appendChild(this.main_box);this.buildHtmlHeader();this.buildHtmlControls();this.main_box.appendChild(g);this.move_list=l.createElement("ol");this.move_list.className="move_list";this.main_box.appendChild(this.move_list);if(h.width!==null){this.container.style.width=h.width+"px"}if(h.board_width!==null){this.header_details_box.style.width=h.board_width+"px"}if(h.move_list_width!==null){this.game_list.style.width=h.move_list_width+"px";this.move_list.style.width=(h.move_list_width-30)+"px";this.move_list.style.height=h.board_width+"px";this.move_control_box.style.width=h.move_list_width+"px";k=document.getElementsByClassName("pgn_ctrl_btn");f=parseInt((h.move_list_width-120)/8,10);for(j=0;j<k.length;j+=1){k[j].style.margin="0 "+f+"px"}}};a.buildHtmlControls=function(){var f=document;this.control_box=f.createElement("div");this.control_box.className="pgn_control_box";this.container.appendChild(this.control_box);this.board_control_box=f.createElement("span");this.board_control_box.className="board_controls";this.control_box.appendChild(this.board_control_box);this.flip_board_btn=f.createElement("a");this.flip_board_btn.className="board_ctrl_btn board_flip";this.flip_board_btn.title="Flip";this.flip_board_btn.onclick=this.board.flip;this.download_btn=f.createElement("a");this.download_btn.className="board_ctrl_btn board_download";this.download_btn.title="Download PGN";this.board_control_box.appendChild(this.flip_board_btn);this.board_control_box.appendChild(this.download_btn);this.move_control_box=f.createElement("span");this.move_control_box.className="move_controls";this.control_box.appendChild(this.move_control_box);this.control_play_elem=f.createElement("a");this.control_play_elem.className="pgn_ctrl_btn pgn_play";this.control_play_elem.title="Play";this.control_play_elem.onclick=b.goPlay;this.control_pause_elem=f.createElement("a");this.control_pause_elem.className="pgn_ctrl_btn pgn_pause";this.control_pause_elem.title="Pause";this.control_pause_elem.onclick=b.goPause;this.control_start_elem=f.createElement("a");this.control_start_elem.className="pgn_ctrl_btn pgn_start";this.control_start_elem.title="Start";this.control_start_elem.onclick=b.goStart;this.control_prev_elem=f.createElement("a");this.control_prev_elem.className="pgn_ctrl_btn pgn_prev";this.control_prev_elem.title="Previous";this.control_prev_elem.onclick=b.goPrev;this.control_next_elem=f.createElement("a");this.control_next_elem.className="pgn_ctrl_btn pgn_next";this.control_next_elem.title="Next";this.control_next_elem.onclick=b.goNext;this.control_end_elem=f.createElement("a");this.control_end_elem.className="pgn_ctrl_btn pgn_end";this.control_end_elem.title="End";this.control_end_elem.onclick=b.goEnd;this.move_control_box.appendChild(this.control_start_elem);this.move_control_box.appendChild(this.control_prev_elem);this.move_control_box.appendChild(this.control_next_elem);this.move_control_box.appendChild(this.control_end_elem)};a.buildHtmlHeader=function(){var f=document;this.header_box=f.createElement("div");this.header_box.className="pgn_header_box";this.container.insertBefore(this.header_box,this.container.firstChild);this.header_details_box=f.createElement("div");this.header_details_box.className="pgn_header_details_box";this.header_box.appendChild(this.header_details_box);this.header_players_elem=f.createElement("span");this.header_players_elem.className="pgn_players";this.header_players_elem.title="Players";this.header_players_elem.innerHTML="Players";this.header_event_elem=f.createElement("span");this.header_event_elem.className="pgn_event";this.header_event_elem.title="Event";this.header_event_elem.innerHTML="Event";this.header_site_elem=f.createElement("span");this.header_site_elem.className="pgn_site";this.header_site_elem.title="Site";this.header_site_elem.innerHTML="Site";this.header_date_elem=f.createElement("span");this.header_date_elem.className="pgn_date";this.header_date_elem.title="Date";this.header_date_elem.innerHTML="Date";this.header_result_elem=f.createElement("span");this.header_result_elem.className="pgn_result";this.header_result_elem.title="Result";this.header_result_elem.innerHTML="Result";this.header_details_box.appendChild(this.header_players_elem);this.header_details_box.appendChild(this.header_event_elem);this.header_details_box.appendChild(this.header_site_elem);this.header_details_box.appendChild(this.header_date_elem);this.header_details_box.appendChild(this.header_result_elem);this.game_list=f.createElement("select");this.game_list.className="game_list";this.game_list.onchange=function(g){a.changeGame(g.currentTarget.value)};this.header_box.appendChild(this.game_list)};a.changeGame=function(k){var l,p,m,j,u,g,s,r,v,n,q,o,t={comment:"",gc:null};c.event="";c.site="";c.date="";c.round="";c.white="";c.black="";c.result="";c.fen="";while(this.move_list.firstChild){this.move_list.removeChild(this.move_list.firstChild)}this.current_move=null;p=c.game_list[k];m=p.match(/\[([^\[%]+)\]/g);for(l=0;l<m.length;l+=1){j=m[l].match(/\[(\S+)\s"(.+?)"\]/);j[1]=j[1].replace(/\s+$/,"");j[2]=j[2].replace(/\s+$/,"");switch(j[1].toLowerCase()){case"event":c.event=j[2];break;case"site":c.site=j[2];break;case"date":c.date=j[2];break;case"round":c.round=j[2];break;case"white":c.white=j[2];break;case"black":c.black=j[2];break;case"result":c.result=j[2];break;case"fen":c.fen=j[2];break}}if(c.fen===""){c.fen="rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1"}this.displayHeader();u=p.match(/\]\s+([{\w][\s\S]+$)/)[1];u=u.replace(/\s*1-0\s*$/,"");u=u.replace(/\s*0-1\s*$/,"");u=u.replace(/\s*1\/2-1\/2\s*$/,"");u=u.replace(/\s*\*\s*$/,"");o=u.match(/\{[^{]*\}/g);u=u.replace(/\{[^{]*\}/g,"{}");g=u.match(/^(\{\})|(\d+[.]{1,3}).+?(?=(\d+[.]{1,3})|$)/g);if(g[0]==="{}"){t=this.getComment(o);this.move(null,t.comment,null,t.gc);t.comment="";t.gc=null}for(l=0;l<g.length;l+=1){s=g[l].match(/\d+[.]{1,3}\s?((?:[^ )]+)\s?(?:\$[\d]+)?)\s?(?:\{\})?/);if(s!==null){n=s[1].match(/[!?=]+/);n=(n&&n[0]?n[0]:null);v=s[1].match(/\$(\d+)/);v=(v&&v[1]?v[1]:null);v=CHESS.nag_code[v];if(v){q=v}else{if(n){q=n}else{q=""}}s[1]=s[1].replace(/[^1-8a-hRNBQKOx\-]*$/,"");s[1]=s[1].replace(/\s*\$.*$/,"");if(/\{\}/.test(s[0])){t=this.getComment(o)}this.move(s[1],t.comment,q,t.gc);t.comment="";t.gc=null;g[l]=g[l].replace(s[0],"");r=g[l].match(/((?:\w[^ )]+)\s?(?:\$[\d]+)?)\s?(?:\{\})?/);if(r!==null){n=r[1].match(/[!?=]+/);n=(n&&n[0]?n[0]:null);v=r[1].match(/\$(\d+)/);v=(v&&v[1]?v[1]:null);v=CHESS.nag_code[v];if(v){q=v}else{if(n){q=n}else{q=""}}r[1]=r[1].replace(/[^1-8a-hRNBQKOx\-]*$/,"");r[1]=r[1].replace(/\s*\$.*$/,"");if(/\{\}/.test(r[0])){t=this.getComment(o)}this.move(r[1],t.comment,q,t.gc);t.comment="";t.gc=null}if(/\)/.test(g[l])){this.endVariation()}if(/\(/.test(g[l])){this.startVariation();if(/\(\{\}/.test(g[l])){t=this.getComment(o);var h=document.createElement("li");h.move="";var f=document.createElement("span");f.setAttribute("class","comment");f.innerHTML=t.comment;h.appendChild(f);if(t.gc!==undefined&&t.gc!==null){h.gc=t.gc}h.setAttribute("data-ply",this.ply);h.fen=a.getSiblingMove(this.current_move.parentNode.previousSibling,-1).fen;h.onclick=b.updateBoard;this.current_move.appendChild(h);t.comment="";t.gc=null}}}}this.current_move=a.move_list.getElementsByTagName("li")[0];this.board.setPosition(this.current_move.fen);b.updateBoard({currentTarget:this.current_move});a.move_list.scrollTop=0};a.getComment=function(j){var g,f={comment:"",gc:{arrows:[],squares:[]}},n,h,m,k,o,l;f.comment=j.shift().replace(/\{/,"").replace(/\}/,"");if(/\[%cal/.test(f.comment)){n=f.comment.match(/\[%cal (?:[GYR]\w{2}\w{2},?\s*)+\]/)[0];h=n.match(/[GYR]\w{2}\w{2},?\s*/g);for(g=0;g<h.length;g+=1){m=h[g].match(/([GYR])(\w{2})(\w{2}),?\s*/);k=m[1];o=m[2];l=m[3];f.gc.arrows.push({color:k,sq1:o,sq2:l})}f.comment=f.comment.replace(n,"")}if(/\[%csl/.test(f.comment)){n=f.comment.match(/\[%csl (?:[GYR]\w{2},?\s*)+\]/)[0];h=n.match(/[GYR]\w{2},?\s*/g);for(g=0;g<h.length;g+=1){m=h[g].match(/([GYR])(\w{2}),?\s*/);k=m[1];o=m[2];f.gc.squares.push({color:k,sq:o})}f.comment=f.comment.replace(n,"")}f.comment=f.comment.replace(/^\s+|\s+$/g,"");return f};a.changeMove=function(g){var f,h;if(a.current_move!==g){if(a.current_move!==null&&g!==null){a.current_move.removeAttribute("class")}if(g!==null){g.className="current";b.updateBoard({currentTarget:g});a.current_move=g;f=a.current_move.offsetTop-a.move_list.offsetTop;f-=parseInt(a.move_list.offsetHeight/2,10);a.move_list.scrollTop=f}}};a.displayHeader=function(){this.header_date_elem.innerHTML=this.getPgnDate(c.date);this.header_players_elem.innerHTML=c.white+" vs "+c.black;this.header_event_elem.innerHTML=c.event;this.header_site_elem.innerHTML=c.site;this.header_result_elem.innerHTML=c.result};a.endVariation=function(){this.current_move=this.current_move.parentNode.parentNode.previousSibling;this.ply=(+this.current_move.getAttribute("data-ply"));this.start_end_variation=true;return this};a.getPgnDate=function(h){var j=["","Jan","Feb","Mar","Apr","May","Jun","Jul","Jun","Sep","Oct","Nov","Dec"],l=h.split("."),i="",k="",g="",f;if(l.length===3&&l[0].length===4&&l[1].length===2&&l[2].length===2){i=l[0];k=parseInt(l[1],10);g=parseInt(l[2],10);k=(k>0&&k<13?j[k]:"");f=(g>0?g+" ":"")+(k!==""?k+" ":"")+(i>0?i+" ":"");f=f.replace(/\s+$/,"")}return f};a.getSiblingMove=function(f,g){if(g===1){while(f=f.nextSibling){if(!(/variation_list/.test(f.className))){break}}}else{if(g===-1){while(f=f.previousSibling){if(!(/variation_list/.test(f.className))){break}}}}return f};a.importFile=function(k){var j,g,f,n,h,m,l;k=k.replace(/^ +/gm,"").replace(/$ +/gm,"");k=k.replace(/\n/g," ").replace(/\s+/g," ");c.game_list=k.split(/[^\w](?:(?:1-0)|(?:0-1)|(?:1\/2-1\/2)|\*)\s*(?=\[)/);if(c.game_list.length>1){for(j=0;j<c.game_list.length;j+=1){g=c.game_list[j];f=g.match(/\[\s*white\s+['"](.*?)['"]\]/i);f=(f!==null&&f.length>1?f[1]:"");n=g.match(/\[\s*black\s+['"](.*?)['"]\]/i);n=(n!==null&&n.length>1?n[1]:"");h=g.match(/\[\s*date\s+['"]([0-9.?]+)['"]\]/i);h=(h!==null&&h.length>1?h[1]:"");m=f+" vs. "+n;l=document.createElement("option");l.value=j;l.text=m;this.game_list.appendChild(l)}}else{this.game_list.style.display="none"}this.changeGame(0)};a.move=function(l,n,p,r){var j,s,g,h,k,q,o,i,m,f;if(!l&&!n){return this}if(this.current_move===null){j=document.createElement("li");if(c.fen.length>0){j.fen=c.fen;m=j.fen.match(/\s+([wbWB])\s+([-kqKQ]+)\s+([-\w]{1,2})\s+(\d+)\s+(\d+)\s*$/);f=m[1].toLowerCase();h=+m[5];this.ply=(h*2)-(f==="w"?2:1);j.setAttribute("data-ply",this.ply)}else{j.setAttribute("data-ply",0)}j.move="";j.onclick=b.updateBoard;this.move_list.appendChild(j);this.current_move=j;if(!l&&typeof n==="string"){g=document.createElement("span");g.setAttribute("class","comment");g.innerHTML=n;j.appendChild(g);if(r!==undefined&&r!==null){j.gc=r}return}}h=(this.ply%2===0?(parseInt(this.ply/2,10)+1)+".&nbsp;":"");if(this.ply%2===1&&this.start_end_variation){h=(parseInt((this.ply-1)/2,10)+1)+"..."}this.start_end_variation=false;this.ply+=1;s=document.createElement("span");s.setAttribute("class","move_text");s.innerHTML=h+l+p+" ";j=document.createElement("li");j.setAttribute("data-ply",this.ply);j.appendChild(s);if(this.current_move.fen===undefined){if(this.current_move.className==="variation"){k=a.getSiblingMove(this.current_move.parentNode.previousSibling,-1).fen}}else{k=this.current_move.fen}q=CHESS.engine.createPosition(k);o=CHESS.engine.getLongNotation(q,l);i=o.split("-");CHESS.engine.moveTemp(q,i[0],i[1]);k=CHESS.engine.getFEN(q);j.move={sq1:i[0],sq2:i[1]};j.fen=k;if(r!==undefined&&r!==null){j.gc=r}j.onclick=b.updateBoard;if(this.current_move.tagName.toLowerCase()==="ol"){this.current_move.appendChild(j)}else{this.current_move.parentNode.appendChild(j)}if(n){g=document.createElement("span");g.setAttribute("class","comment");g.innerHTML=n;j.appendChild(g)}this.current_move=j;return this};a.startVariation=function(){var g,f;if(this.current_move.nextSibling===null){g=document.createElement("li");g.setAttribute("class","variation_list")}else{g=this.current_move.nextSibling}f=document.createElement("ol");f.setAttribute("class","variation");g.appendChild(f);this.current_move.parentNode.appendChild(g);this.current_move=f;this.ply-=1;this.start_end_variation=true;return this};this.flip=function(){a.board.flip()};this.load=function(f,h){var g=new XMLHttpRequest();a.download_btn.href=f;g.onreadystatechange=function(){var i;if(g.readyState===4&&g.status===200){i=g.responseText;a.importFile(i);if(typeof h==="function"){h()}}};g.open("GET",f,true);g.send()};this.loadText=function(f){a.importFile(f)};e=function(f){if(d.width===undefined){d.width=null;d.board_width=null;d.move_list_width=null}else{d.width=parseInt(d.width,10);d.board_width=parseInt((d.width-10)*0.54,10);d.move_list_width=parseInt(d.width,10)-d.board_width}a.board=new CHESS.Board({height:d.board_width,width:d.board_width,square_color_light:d.square_color_light,square_color_dark:d.square_color_dark,square_hover_dark:d.square_hover_dark,square_hover_light:d.square_hover_light,square_dark:d.square_dark,square_light:d.square_light,gc_opacity:d.gc_opacity,highlight_move:d.highlight_move,highlight_move_color:d.highlight_move_color,highlight_move_opacity:d.highlight_move_opacity,show_row_col_labels:d.show_row_col_labels,piece_set:d.piece_set});a.buildHtml(d,a.board.getCanvas());a.container.onkeydown=function(g){g.stopPropagation();if(g.keyCode===37){b.goPrev()}else{if(g.keyCode===39){b.goNext()}}};a.container.getElementsByClassName("chessboard")[0].addEventListener("keydown",function(g){g.stopPropagation();if(g.keyCode===37){b.goPrev()}else{if(g.keyCode===39){b.goNext()}}});if(d.url!==undefined){f.load(d.url)}else{if(d.pgn_text!==undefined){f.loadText(d.pgn_text)}}};e(this)};
